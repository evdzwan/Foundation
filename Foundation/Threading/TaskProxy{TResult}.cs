...
sealed class TaskProxy<TResult>(Task<TResult> task) : ITask<TResult>
{
    ...
    public IConfiguredTask<TResult> ConfigureAwait(bool continueOnCapturedContext) => new ConfiguredTask<TResult>(task, continueOnCapturedContext);
    public ITaskAwaiter<TResult> GetAwaiter() => new TaskAwaiterProxy(task.GetAwaiter());
    ...
    sealed class TaskAwaiterProxy(TaskAwaiter<TResult> taskAwaiter) : ITaskAwaiter<TResult>
    {
        ...
        public TResult GetResult() => taskAwaiter.GetResult();
